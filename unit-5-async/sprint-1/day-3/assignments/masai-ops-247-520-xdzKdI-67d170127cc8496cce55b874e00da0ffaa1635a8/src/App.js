...
function App() {
  ...
  // console.log(submittedData.state.password)
 
  }
    if(submittedData.state !== undefined){
  ...
  return (
    <div className="App">
      ...
      <form className="form-wrapper" data-testid="form-wrapper"  onSubmit={handleChange} >
      ...
      <div>
        ...
        <div data-testid="submitted-data-email"> {submittedData.state !== undefined && "User Email:"}{submittedData.state !== undefined && submittedData.state.email}</div>
        <div data-testid="submitted-data-password"> {submittedData.state !== undefined && "User Password:"}{submittedData.state !== undefined && submittedData.state.password} </div>
      </div>
       
      
      <div data-testid="no-details-container">{submittedData.state == undefined && "No user found"}</div>
    </div>
  );
}
