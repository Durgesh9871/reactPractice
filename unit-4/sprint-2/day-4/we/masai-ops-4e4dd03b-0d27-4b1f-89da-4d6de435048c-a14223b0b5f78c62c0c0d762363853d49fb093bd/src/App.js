...
import Play from "./Components/PlayPause"
...
export default function App() {
  return (
    <div className="App">
      < Heading/>
      <Image src="https://cp.masaischool.com/static/media/logo.ad26cbefd4555370054eca5c757aa4b3.svg" alt="masaiImage" width="400px" height="400px"/>
      <Play />
    </div>
  );
}
